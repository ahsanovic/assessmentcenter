...
class Index extends Component
{
    ...
    public function render()
    {
        $data = Event::withCount([
            ...
            'peserta as peserta_selesai_count' => function ($query) {
        ...
        return view('livewire.admin.data-tes.tes-potensi.tes-selesai.index', compact('data', 'option_jabatan_diuji', 'option_event'));
    }
}
