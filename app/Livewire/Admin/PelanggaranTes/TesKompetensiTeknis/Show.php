...
namespace App\Livewire\Admin\PelanggaranTes\TesKompetensiTeknis;
...
class Show extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.pelanggaran-tes.tes-kompetensi-teknis.show', [
            'data' => $data,
        ]);
    }
    ...
    {
        try {
            // $data = LogPelanggaran::where('event_id', $this->id_event)
            //     ->where('peserta_id', $this->selected_id)
            //     ->get();

            // $old_data = $data->toArray();

            // activity_log($data, 'delete', 'pelanggaran', $old_data);
