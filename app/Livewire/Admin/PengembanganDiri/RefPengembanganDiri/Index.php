...
class Index extends Component
{
    ...
    {
        try {
            $data = RefPengembanganDiri::find($this->selected_id);
            $old_data = $data->getOriginal();

            activity_log($data, 'delete', 'ref-pengembangan-diri', $old_data);
    ...
    public function save()
    {
        ...
        try {
            if ($this->isUpdate) {
                $data = RefPengembanganDiri::findOrFail($this->editId);
                $old_data = $data->getOriginal();
                ...
                activity_log($model, 'create', 'ref-pengembangan-diri');
