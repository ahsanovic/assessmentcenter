    ...
    <div class="row">
        <div class="row">
            ...
            <x-portofolio.tab-nav :nav="[
                ['url' => route('peserta.biodata'), 'title' => 'Biodata', 'active' => 'active', 'icon' => 'user', 'color' => 'primary'],
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group" wire:ignore>
                                        <input type="text" data-flatpickr wire:model.live="tgl_lahir"
                                            class="form-control @error('tgl_lahir') is-invalid @enderror"
                                            placeholder="Pilih tanggal lahir" readonly="readonly">
