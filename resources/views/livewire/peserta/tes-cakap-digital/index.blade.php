        ...
        <div class="col-md-8 col-lg-6">
            ...
            <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                <div class="card-body p-4 text-white text-center">
                    ...
                    <h3 class="mb-2">Tes Cakap Digital</h3>
                    <p class="mb-0 opacity-75">Uji literasi dan kompetensi digital Anda</p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="rounded-circle bg-info bg-opacity-10 p-3 d-inline-flex mb-3" wire:ignore>
                            <i class="text-info" data-feather="key" style="width: 32px; height: 32px;"></i>
                        </div>
