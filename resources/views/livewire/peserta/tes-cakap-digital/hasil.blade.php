<div>
    <div class="row mb-4">
        <div class="col">
            <h3 class="text-center">Tes Literasi Digital dan Emerging Skill</h3>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body d-flex justify-content-center text-center">
                    <div style="font-family: 'Helvetica Neue', sans-serif;">
                        ...
                        <h6>Anda telah menyelesaikan Tes Literasi Digital dan Emerging Skill dengan baik dan penuh semangat!</h6>
                        <div class="row mt-4">
