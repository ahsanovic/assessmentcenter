...
<style>
    ...
    .btn-cakap-selesai {
        ...
        background: linear-gradient(135deg, var(--cakap-from) 0%, var(--cakap-to) 100%);
        box-shadow: 0 8px 18px rgba(79, 172, 254, 0.35);
        transition: transform 0.15s ease, box-shadow 0.15s ease, filter 0.15s ease;
    }
    .btn-cakap-selesai:hover,
    .btn-cakap-selesai:focus {
        color: #fff !important;
        filter: brightness(1.05);
        box-shadow: 0 10px 22px rgba(0, 242, 254, 0.4);
        transform: translateY(-1px);
    }
    .btn-cakap-selesai:active {
        transform: translateY(0);
        box-shadow: 0 4px 12px rgba(79, 172, 254, 0.3);
    }
    .btn-cakap-selesai svg,
    .btn-cakap-selesai i {
        width: 18px;
        height: 18px;
        stroke-width: 2.25;
...
{{-- UI dikelola Alpine + wire:ignore agar save/navigate tidak morph (tanpa blink) --}}
<div
    wire:ignore
    x-data="tesCakapDigitalUjian({
        ...
        <div class="card-body py-3">
            <div class="row align-items-center g-3">
                ...
                <div class="col-6 col-md-3 text-md-end">
                    <button type="button" class="btn btn-cakap-selesai"
                        @click="Swal.fire({
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn btn-info text-white" @click="saveAndNext()"
            ...
            <div class="d-flex flex-wrap gap-2">
                <template x-for="n in nomorList" :key="n">
                    <button type="button"
                        ...
                        :style="n === nomor ? 'box-shadow: 0 0 0 3px rgba(13, 202, 240, 0.5);' : ''"
                        @click="navigate(n)"
                        :disabled="saving"
                    >
                        <span x-text="n"></span>
...
@push('js')
<script>
    window.tesCakapDigitalUjian = function (initial) {
        return {
            nomor: initial.nomor,
            jml: initial.jml,
            ...
            toggleFlag() {
                ...
                // Pastikan pilihan jawaban tidak ikut ter-reset saat toggle flag
                this.$nextTick(() => {
            ...
            async saveAndNext() {
                ...
                this.saving = true;
                try {
                    // Flag tetap dipertahankan setelah simpan (seperti sikma)
...
<script>
    (function () {
        if (window.__cakapDigitalTimerStarted) {
            return;
        }
        window.__cakapDigitalTimerStarted = true;
