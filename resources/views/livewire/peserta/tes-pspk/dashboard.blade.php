                ...
                <div class="card-body d-flex justify-content-center text-center">
                    <div style="font-family: 'Helvetica Neue', sans-serif;">
                        <h5 class="text-center">
                            <p class="mb-1">Selamat datang! Anda akan mengikuti Tes {{ auth()->guard('peserta')->user()->event->metodeTes->metode_tes }} sebagai bagian dari pengembangan kompetensi diri. </p>
