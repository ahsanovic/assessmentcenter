...
<div
    wire:ignore
    x-data="tesIntelektualSubtes2Ujian({
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn btn-warning" @click="saveAndNext()"
            ...
            <div class="d-flex flex-wrap gap-2">
                <template x-for="n in nomorList" :key="n">
                    <button type="button"
                        ...
                        :style="n === nomor ? 'box-shadow: 0 0 0 3px rgba(255, 193, 7, 0.5);' : ''"
                        @click="navigate(n)"
                        :disabled="saving"
                    >
                        <span x-text="n"></span>
...
@push('js')
<script>
    window.tesIntelektualSubtes2Ujian = function (initial) {
        const base = {
            nomor: initial.nomor,
            jml: initial.jml,
...
<script>
    (function () {
        if (window.__intelektualSubtes2TimerStarted) {
            return;
        }
        window.__intelektualSubtes2TimerStarted = true;
