            ...
            <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="card-body p-4 text-white text-center">
                    <div class="rounded-circle bg-white bg-opacity-25 p-3 d-inline-flex mb-3" wire:ignore>
                        <i data-feather="cpu" style="width: 40px; height: 40px;"></i>
                    </div>
                    <h3 class="mb-2">Tes Intelektual</h3>
                    <p class="mb-0 opacity-75">Uji kemampuan kognitif dan analitis Anda</p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="rounded-circle bg-primary bg-opacity-10 p-3 d-inline-flex mb-3" wire:ignore>
                            <i class="text-primary" data-feather="key" style="width: 32px; height: 32px;"></i>
                        </div>
