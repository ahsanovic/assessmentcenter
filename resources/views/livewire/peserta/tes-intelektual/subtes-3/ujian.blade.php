        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 mb-3">
                    <div>Carilah kubus pada soal di bawah yang memiliki tanda dan posisi yang sama dengan salah satu pilihan jawaban dari ke-5 kubus (a, b, c, d, dan e)</div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-12">
                    ...
                    @if(
                        ...
                        <div class="d-flex flex-wrap gap-3 mb-3 ps-3">
