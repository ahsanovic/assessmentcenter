        ...
        <div class="card-body p-4">
            ...
            <div class="mb-4">
                <div class="bg-light rounded-3 p-3 mb-3">
                    <p class="mb-0 text-muted">Carilah kubus pada soal di bawah yang memiliki tanda dan posisi yang sama dengan salah satu pilihan jawaban dari ke-5 kubus (A, B, C, D, dan E)</p>
                </div>
                @if(preg_match('/\.(jpg|jpeg|png)$/i', $soal->image_soal))
                <div class="text-center mb-3">
                    <p class="fw-bold mb-2">Kubus Soal:</p>
            ...
            @if(
                ...
                <div class="mb-3">
                    <p class="fw-bold mb-3">Pilih Jawaban:</p>
                    <div class="d-flex flex-wrap gap-3">
                        @foreach(['A','B','C','D','E'] as $opsi)
                            ...
                            <label class="option-image-card {{ ($jawaban_user[$nomor_sekarang - 1] ?? '') == $opsi ? 'selected' : '' }}">
                                ...
                                @if(!empty($soal->$fieldImage) && preg_match('/\.(jpg|jpeg|png|gif|webp)$/i', $soal->$fieldImage))
            ...
            <div class="d-flex flex-wrap gap-2 mt-4">
                ...
                <button class="btn btn-danger" wire:click="saveAndNext({{ $nomor_sekarang }})" id="btn-simpan" disabled>
                    Simpan & Lanjutkan
                ...
                @for ($i = 0; $i < 1; $i++)
                    @for ($j = 1; $j <= 12; $j++)
                        ...
                        <button wire:click="navigate({{ $nomor_soal }})"
                            ...
                            style="{{ $nomor_soal == $nomor_sekarang ? 'box-shadow: 0 0 0 3px rgba(220, 53, 69, 0.5);' : '' }}"
                        >
                            {{ $nomor_soal }}
