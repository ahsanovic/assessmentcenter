    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button class="btn btn-primary" wire:click="saveAndNext({{ $nomor_sekarang }})" id="btn-simpan" disabled>
                    Simpan & Lanjutkan
                ...
                @for ($i = 0; $i < 1; $i++)
                    @for ($j = 1; $j <= 15; $j++)
                        ...
                        <button wire:click="navigate({{ $nomor_soal }})"
                            ...
                            style="{{ $nomor_soal == $nomor_sekarang ? 'box-shadow: 0 0 0 3px rgba(13, 110, 253, 0.5);' : '' }}"
                        >
                            {{ $nomor_soal }}
