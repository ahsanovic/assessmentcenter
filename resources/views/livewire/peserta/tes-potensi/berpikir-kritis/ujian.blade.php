...
<div
    wire:ignore
    x-data="tesPotensiBerpikirKritisUjian({
        ...
        <div class="card-body p-4 text-white">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                <div class="d-flex align-items-center mb-3 mb-md-0">
                    ...
                    <div>
                        <h4 class="mb-0">Tes Berpikir Kritis dan Strategis</h4>
                        <small class="opacity-75">Tes Potensi - Sub Tes {{ $current_sequence }} dari 7</small>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-2">
                    @for($i = 1; $i <= 7; $i++)
                        <span class="badge {{ $i <= $current_sequence ? 'bg-white text-primary' : 'bg-white bg-opacity-25' }}" style="width: 28px; height: 28px; display: flex; align-items: center; justify-content: center;">{{ $i }}</span>
                    @endfor
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <span class="badge text-white me-3 px-3 py-2" style="font-size: 1rem; background-color: #667eea;">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn text-white" style="background-color: #667eea;" @click="saveAndNext()"
            ...
            <div class="d-flex flex-wrap gap-2">
                <template x-for="n in nomorList" :key="n">
                    <button type="button"
                        ...
                        :style="n === nomor ? 'box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.5);' : ''"
                        @click="navigate(n)"
                        :disabled="saving"
                    >
                        <span x-text="n"></span>
...
@push('js')
<script>
    window.tesPotensiBerpikirKritisUjian = function (initial) {
        return {
            nomor: initial.nomor,
            jml: initial.jml,
...
<script>
    (function () {
        if (window.__potensiBerpikirKritisTimerStarted) {
            return;
        }
        window.__potensiBerpikirKritisTimerStarted = true;
