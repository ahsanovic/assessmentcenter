        ...
        <div class="col-md-8 col-lg-6">
            ...
            <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                <div class="card-body p-4 text-white text-center">
                    ...
                    <p class="mb-0 opacity-75">Uji potensi dan kemampuan dasar Anda</p>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <div class="rounded-circle bg-danger bg-opacity-10 p-3 d-inline-flex mb-3" wire:ignore>
                            <i class="text-danger" data-feather="key" style="width: 32px; height: 32px;"></i>
                        </div>
