...
<style>
    ...
    .btn-ujian-selesai:focus {
        ...
        box-shadow: 0 10px 22px rgba(0, 184, 148, 0.4);
...
<div
    wire:ignore
    x-data="tesPotensiPengembanganDiriUjian({
    ...
    "
>
    <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #00b894 0%, #00cec9 100%);">
        <div class="card-body p-4 text-white">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                <div class="d-flex align-items-center mb-3 mb-md-0">
                    ...
                    <div>
                        <h4 class="mb-0">Tes Belajar Cepat dan Pengembangan Diri</h4>
                        <small class="opacity-75">Tes Potensi - Sub Tes {{ $current_sequence }} dari 7</small>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-2">
                    @for($i = 1; $i <= 7; $i++)
                        <span class="badge {{ $i <= $current_sequence ? 'bg-white text-success' : 'bg-white bg-opacity-25' }}" style="width: 28px; height: 28px; display: flex; align-items: center; justify-content: center;">{{ $i }}</span>
                    @endfor
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <span class="badge text-white me-3 px-3 py-2" style="font-size: 1rem; background-color: #00b894;">
        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3 mb-4">
                <template x-for="opsi in opsiList" :key="opsi.value">
                    <div class="col-12 col-md-6" x-show="opsi.show">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn text-white" style="background-color: #00b894;" @click="saveAndNext()"
            ...
            <div class="d-flex flex-wrap gap-2">
                <template x-for="n in nomorList" :key="n">
                    <button type="button"
                        ...
                        :style="n === nomor ? 'box-shadow: 0 0 0 3px rgba(0, 184, 148, 0.5);' : ''"
                        @click="navigate(n)"
                        :disabled="saving"
                    >
                        <span x-text="n"></span>
...
@push('js')
<script>
    window.tesPotensiPengembanganDiriUjian = function (initial) {
        return {
            nomor: initial.nomor,
            jml: initial.jml,
            ...
            get opsiList() {
                return [
                    ...
                    { value: 'C', label: this.opsiC, show: false },
                    { value: 'D', label: this.opsiD, show: false },
                    { value: 'E', label: this.opsiE, show: false }
                ];
            },

            isAnswered(value) {
                return ["A","B"].includes(String(value || ''));
            },
...
<script>
    (function () {
        if (window.__potensiPengembanganDiriTimerStarted) {
            return;
        }
        window.__potensiPengembanganDiriTimerStarted = true;
