        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3 mb-4">
                <div class="col-12 col-md-6">
                    <label class="option-card d-flex align-items-center w-100 h-100 {{ ($jawaban_user[$nomor_sekarang - 1] ?? '') == 'A' ? 'selected' : '' }}">
                ...
                <div class="col-12 col-md-6">
                    <label class="option-card d-flex align-items-center w-100 h-100 {{ ($jawaban_user[$nomor_sekarang - 1] ?? '') == 'B' ? 'selected' : '' }}">
                        <input class="form-check-input me-3" type="radio"
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button class="btn text-white" style="background-color: #00b894;" wire:click="saveAndNext({{ $nomor_sekarang }})" id="btn-simpan" disabled>
                    Simpan & Lanjutkan
            ...
            <div class="d-flex flex-wrap gap-2">
                @for ($i = 0; $i < $jml_soal; $i++)
                    ...
                    <button wire:click="navigate({{ $nomor_soal }})"
                        ...
                        style="{{ $nomor_soal == $nomor_sekarang ? 'box-shadow: 0 0 0 3px rgba(0, 184, 148, 0.5);' : '' }}"
                    >
                        {{ $nomor_soal }}
