<div>
    <div class="row">
        ...
        <div class="col-sm-1 col-md-3 col-lg-4">
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title mb-4">Tes Berpikir Kritis dan Strategis</h5>
                    <button class="btn btn-inverse-success"
                        {{ isset($test_berpikir_kritis->is_finished) ? 'disabled' : '' }}
                        x-data
                        @click="Swal.fire({
                            title: 'Apakah Anda yakin memulai tes?',
                            icon: 'warning',
        ...
        <div class="col-sm-1 col-md-3 col-lg-4">
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title mb-4">Tes Kesadaran Diri</h5>
                    <button class="btn btn-inverse-success"
                        {{ isset($test_kesadaran_diri->is_finished) ? 'disabled' : '' }}
                        x-data
                        @click="Swal.fire({
                            title: 'Apakah Anda yakin memulai tes?',
                            icon: 'warning',
