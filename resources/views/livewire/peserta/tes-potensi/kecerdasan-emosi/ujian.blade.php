...
<div
    wire:ignore
    x-data="tesPotensiKecerdasanEmosiUjian({
    ...
    "
>
    <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #e91e63 0%, #9c27b0 100%);">
        <div class="card-body p-4 text-white">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                <div class="d-flex align-items-center mb-3 mb-md-0">
                    <div class="rounded-circle bg-white bg-opacity-25 p-2 me-3">
                        <i data-feather="heart" style="width: 28px; height: 28px;"></i>
                    </div>
                    <div>
                        <h4 class="mb-0">Tes Kecerdasan Emosi</h4>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <span class="badge text-white me-3 px-3 py-2" style="font-size: 1rem; background-color: #e91e63;">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn text-white" style="background-color: #e91e63;" @click="saveAndNext()"
            ...
            <div class="d-flex flex-wrap gap-2">
                <template x-for="n in nomorList" :key="n">
                    <button type="button"
                        ...
                        :style="n === nomor ? 'box-shadow: 0 0 0 3px rgba(233, 30, 99, 0.5);' : ''"
                        @click="navigate(n)"
                        :disabled="saving"
                    >
                        <span x-text="n"></span>
...
@push('js')
<script>
    window.tesPotensiKecerdasanEmosiUjian = function (initial) {
        return {
            nomor: initial.nomor,
            jml: initial.jml,
...
<script>
    (function () {
        if (window.__potensiKecerdasanEmosiTimerStarted) {
            return;
        }
        window.__potensiKecerdasanEmosiTimerStarted = true;
