    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button class="btn text-white" style="background-color: #ff6b6b;" wire:click="saveAndNext({{ $nomor_sekarang }})" id="btn-simpan" disabled>
                    Simpan & Lanjutkan
            ...
            <div class="d-flex flex-wrap gap-2">
                @for ($i = 0; $i < $jml_soal; $i++)
                    ...
                    <button wire:click="navigate({{ $nomor_soal }})"
                        ...
                        style="{{ $nomor_soal == $nomor_sekarang ? 'box-shadow: 0 0 0 3px rgba(255, 107, 107, 0.5);' : '' }}"
                    >
                        {{ $nomor_soal }}
