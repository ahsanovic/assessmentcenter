...
<div
    wire:ignore
    x-data="tesPotensiMotivasiKomitmenUjian({
    ...
    "
>
    <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%);">
        <div class="card-body p-4 text-white">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                <div class="d-flex align-items-center mb-3 mb-md-0">
                    <div class="rounded-circle bg-white bg-opacity-25 p-2 me-3">
                        <i data-feather="flag" style="width: 28px; height: 28px;"></i>
                    </div>
                    <div>
                        <h4 class="mb-0">Tes Motivasi dan Komitmen</h4>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <span class="badge text-white me-3 px-3 py-2" style="font-size: 1rem; background-color: #ff6b6b;">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn text-white" style="background-color: #ff6b6b;" @click="saveAndNext()"
            ...
            <div class="d-flex flex-wrap gap-2">
                <template x-for="n in nomorList" :key="n">
                    <button type="button"
                        ...
                        :style="n === nomor ? 'box-shadow: 0 0 0 3px rgba(255, 107, 107, 0.5);' : ''"
                        @click="navigate(n)"
                        :disabled="saving"
                    >
                        <span x-text="n"></span>
...
@push('js')
<script>
    window.tesPotensiMotivasiKomitmenUjian = function (initial) {
        return {
            nomor: initial.nomor,
            jml: initial.jml,
...
<script>
    (function () {
        if (window.__potensiMotivasiKomitmenTimerStarted) {
            return;
        }
        window.__potensiMotivasiKomitmenTimerStarted = true;
