...
<style>
    ...
    .btn-ujian-selesai {
        ...
        box-shadow: 0 8px 18px rgba(56, 239, 125, 0.35);
    ...
    .btn-ujian-selesai:focus {
        ...
        box-shadow: 0 10px 22px rgba(56, 239, 125, 0.4);
...
<div
    wire:ignore
    x-data="tesPotensiKesadaranDiriUjian({
    ...
    "
>
    <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #38ef7d 0%, #11998e 100%);">
        <div class="card-body p-4 text-white">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                <div class="d-flex align-items-center mb-3 mb-md-0">
                    ...
                    <div>
                        <h4 class="mb-0">Tes Kesadaran Diri</h4>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 py-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <span class="badge text-white me-3 px-3 py-2" style="font-size: 1rem; background-color: #11998e;">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn text-white" style="background-color: #11998e;" @click="saveAndNext()"
            ...
            <div class="d-flex flex-wrap gap-2">
                <template x-for="n in nomorList" :key="n">
                    <button type="button"
                        ...
                        :style="n === nomor ? 'box-shadow: 0 0 0 3px rgba(56, 239, 125, 0.5);' : ''"
                        @click="navigate(n)"
                        :disabled="saving"
                    >
                        <span x-text="n"></span>
...
@push('js')
<script>
    window.tesPotensiKesadaranDiriUjian = function (initial) {
        return {
            nomor: initial.nomor,
            jml: initial.jml,
...
<script>
    (function () {
        if (window.__potensiKesadaranDiriTimerStarted) {
            return;
        }
        window.__potensiKesadaranDiriTimerStarted = true;
