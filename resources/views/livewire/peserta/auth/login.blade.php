            ...
            <div class="row">
                ...
                <div class="col-md-8 ps-md-0">
                    <div class="auth-form-wrapper px-4 py-5">
                        ...
                        <h5 class="text-secondary fw-normal mb-4">Selamat Datang Peserta Assessment!</h5>
                        <form class="forms-sample" wire:submit="login">
                        <div class="mb-3">
                            <label for="id-number" class="form-label">NIP/NIK</label>
                            <input type="text" wire:model="id_number" class="form-control @error('id_number') is-invalid @enderror" id="id-number" placeholder="Masukkan NIP jika Anda ASN atau NIK jika Anda Non ASN">
