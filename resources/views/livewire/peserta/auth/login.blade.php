        ...
        <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 1.5rem;">
            <div class="row g-0">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="h-100 position-relative" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); min-height: 500px;">
                        <!-- Decorative Elements -->
                        ...
                        <div class="d-flex flex-column align-items-center justify-content-center h-100 p-4 text-white position-relative">
                            ...
                            <!-- Text -->
                            <h3 class="fw-bold mb-2 text-center">Portal Peserta</h3>
                            <p class="text-center opacity-75 mb-0 px-3">
                                Akses tes dan assessment center kapan saja, di mana saja
                            </p>
                    ...
                    <div class="p-4 p-md-5">
                        ...
                        <div class="mb-4">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle p-2 me-3" style="background: rgba(17, 153, 142, 0.1);" wire:ignore>
                                    <i data-feather="edit-3" style="width: 24px; height: 24px; color: #11998e;"></i>
                                </div>
                                <div>
                                    <h5 class="fw-semibold mb-0">Selamat Datang, Peserta!</h5>
                                    <small class="text-muted">Masuk untuk mengikuti assessment</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <form class="forms-sample" wire:submit="login">
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" 
                                        ...
                                        id="id-number" 
                                        placeholder=" Masukkan NIP jika ASN atau NIK jika Non ASN"
                            ...
                            <div class="d-grid mt-4" wire:ignore>
                                <button type="submit" class="btn btn-lg text-white d-flex align-items-center justify-content-center gap-2" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); border: none; border-radius: 0.75rem; padding: 0.875rem;">
                        ...
                        <!-- Info Box -->
                        <div class="mt-4 p-3 rounded-3" style="background: rgba(17, 153, 142, 0.08);">
                            <div class="d-flex align-items-start" wire:ignore>
                                <i data-feather="info" style="width: 18px; height: 18px; color: #11998e;" class="me-2 mt-1 flex-shrink-0"></i>
                                <div>
                                    <small class="text-muted">
                                        <strong class="d-block mb-1" style="color: #11998e;">Informasi Login</strong>
                                        Gunakan NIP untuk ASN atau NIK untuk Non ASN. Password sesuai yang diberikan oleh panitia.
                                    </small>
                                </div>
                            </div>
                        </div>
