<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Data Referensi Indikator Berpikir Kritis dan Strategis</h6>
                    <a href="{{ route('admin.ref-indikator-berpikir-kritis.create') }}" class="btn btn-xs btn-outline-primary mt-3">Tambah</a>
                                        ...
                                        <td>
                                            <div class="btn-group dropstart">
                                                <a
                                                    ...
                                                    wire:navigate
                                                    href="{{ route('admin.ref-indikator-berpikir-kritis.edit', $item->id) }}"
                                                >
                                                    Edit
                                                </a>
