<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <x-btn-add :url="route('admin.ref-aspek-berpikir-kritis.create')" class="mb-4" />
                            ...
                            <tbody>
                                @foreach ($data as $index => $item)
                                    <tr class="@if($loop->iteration % 2 == 1) bg-body @endif border-bottom">
                                        ...
                                        <td>
                                            <x-table.btn-link :route="'admin.ref-aspek-berpikir-kritis.edit'" :params="['id' => $item->id]" :icon="'edit-3'" :tooltip="'Edit'" :color="'success'" :navigate="true" :disabled="auth()->user()->role == 'user'" />
