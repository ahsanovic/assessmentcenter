        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Metode Tes" icon="plus-circle" />
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-6">
                                    <div class="input-group" wire:ignore>
                                        ...
                                        <input wire:model.live.debounce="search" class="form-control" placeholder="cari metode tes...">
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                ...
                                @if($data->count() === 0)
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-4">
                                            ...
                                            <div class="mt-2 fw-semibold">Tidak ada data metode tes...</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Metode Tes' : 'Tambah Metode Tes Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui informasi metode tes' : 'Isi form untuk menambahkan metode tes' }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="padding: 32px; background: #f8f9fa;">
                    <form wire:submit="save">
                        <x-form.input
                            label="Metode Tes"
                            icon="layers"
                            model="form.metode_tes"
                            placeholder="Masukkan nama metode tes"
                            :required="true"
                        />
                    </form>
                </div>
