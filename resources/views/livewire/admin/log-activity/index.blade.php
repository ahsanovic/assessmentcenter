<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Aktifitas Log Pengguna</h6>
                    <h6 class="mt-4 text-danger"><i class="link-icon" data-feather="filter"></i> Filter</h6>
                    <div class="row mt-2">
                        <div class="col-md-2">
                            <div class="mb-3">
                                <input wire:model.live.debounce="search" class="form-control form-control-sm" placeholder="cari pengguna" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mb-3">
                                <select wire:model.live="action" class="form-select form-select-sm" id="jabatan-diuji">
