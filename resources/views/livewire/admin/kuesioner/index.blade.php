        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Kuesioner" icon="plus-circle" />
                                ...
                                @if($data->count() === 0)
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-4">
                                            ...
                                            <div class="mt-2 fw-semibold">Tidak ada data kuesioner...</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Kuesioner' : 'Tambah Kuesioner Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui kuesioner' : 'Isi form untuk menambahkan kuesioner' }}
                            </p>
                        </div>
                    </div>
                    ...
                    <form wire:submit="save">
                        ...
                        >
                            <div class="form-check">
                                <input 
                                    type="radio" 
                                    class="form-check-input @error('form.is_esai') is-invalid @enderror" 
                                    wire:model="form.is_esai"
                                    id="esaiYa" 
                                    value="t"
                                    style="cursor: pointer;"
                                >
                                <label class="form-check-label" for="esaiYa" style="cursor: pointer;">
                                    <span class="badge bg-success">Ya</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input 
                                    ...
                                    style="cursor: pointer;"
                                >
                                <label class="form-check-label" for="esaiTidak" style="cursor: pointer;">
