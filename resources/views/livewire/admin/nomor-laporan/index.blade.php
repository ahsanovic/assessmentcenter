<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Data Nomor Laporan Penilaian</h6>
                    <a href="{{ route('admin.nomor-laporan.create') }}" wire:navigate class="btn btn-xs btn-outline-primary mt-3">Tambah</a>
                    <h6 class="mt-4 text-danger"><i class="link-icon" data-feather="filter"></i> Filter</h6>
                    <div class="row mt-2">
                        <div class="col-sm-3">
                            <div class="mb-3">
                                <input wire:model.live.debounce="search" class="form-control form-control-sm" placeholder="cari nomor laporan" />
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="mb-3">
                                        ...
                                        <td>
                                            <div class="btn-group dropstart">
                                                <a
                                                    ...
                                                    wire:navigate
                                                    href="{{ route('admin.nomor-laporan.edit', $item->id) }}"
                                                >
                                                    Edit
                                                </a>
