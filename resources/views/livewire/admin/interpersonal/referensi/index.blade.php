<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Data Referensi Instrumen Interpersonal</h6>
                    <a href="{{ route('admin.ref-interpersonal.create') }}" wire:navigate class="btn btn-xs btn-outline-primary mt-3">Tambah</a>
                                        ...
                                        <td>
                                            <div class="btn-group dropstart">
                                                <a
                                                    ...
                                                    wire:navigate
                                                    href="{{ route('admin.ref-interpersonal.edit', $item->id) }}"
                                                >
                                                    Edit
                                                </a>
