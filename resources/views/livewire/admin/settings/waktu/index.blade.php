        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Waktu Tes" icon="plus-circle" />
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Waktu Tes' : 'Tambah Waktu Tes Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui waktu tes' : 'Isi form untuk menambahkan waktu tes' }}
                            </p>
                        </div>
                    </div>
                        ...
                        >
                            <div class="form-check">
                                <input 
                                    ...
                                    style="cursor: pointer;"
                                >
                                <label class="form-check-label" for="aktifWaktu" style="cursor: pointer;">
                            ...
                            <div class="form-check">
                                <input 
                                    ...
                                    style="cursor: pointer;"
                                >
                                <label class="form-check-label" for="nonAktifWaktu" style="cursor: pointer;">
