        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Soal Motivasi dan Komitmen" icon="plus-circle" />
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Soal Motivasi dan Komitmen' : 'Tambah Soal Motivasi dan Komitmen Baru' }}
                            </h5>
