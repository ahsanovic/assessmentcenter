        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Soal Cakap Digital" icon="plus-circle" />
                    ...
                    <div class="card mt-4 mb-4 bg-light-subtle">
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-4">
                                    <select wire:model.live="jenis_soal" class="form-select" id="jenis-soal">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Soal Cakap Digital' : 'Tambah Soal Cakap Digital Baru' }}
                            </h5>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select wire:model="form.jenis_soal" class="form-select @error('form.jenis_soal') is-invalid @enderror">
                                        <option value="">Pilih jenis soal</option>
                                        <option value="1">1 - Literasi Digital</option>
                                        <option value="2">2 - Emerging Skill</option>
                                    </select>
