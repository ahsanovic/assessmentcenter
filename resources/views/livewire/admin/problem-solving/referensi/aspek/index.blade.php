<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Data Referensi Aspek Problem Solving</h6>
                    <a href="{{ route('admin.ref-aspek-problem-solving.create') }}" wire:navigate class="btn btn-xs btn-outline-primary mt-3">Tambah</a>
