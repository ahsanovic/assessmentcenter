<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <x-modal.btn-add text="Tambah Referensi Aspek" icon="plus-circle" wire:click="openModal" />
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Referensi Aspek' : 'Tambah Referensi Aspek Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui informasi referensi aspek' : 'Isi form untuk menambahkan referensi aspek' }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="padding: 32px; background: #f8f9fa;">
                    <form wire:submit="save">
                        ...
                        <x-form.input
                            ...
                            model="aspek_nomor"
                            type="number"
                            placeholder="Masukkan nomor aspek"
                            :required="true"
                        />

                        <div class="mb-3">
                            <label class="form-label fw-semibold">
                                <i class="link-icon me-2" data-feather="list"></i>
                                Nomor Indikator
                            </label>
