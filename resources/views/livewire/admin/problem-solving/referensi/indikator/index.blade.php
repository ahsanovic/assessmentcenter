<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <x-modal.btn-add text="Tambah Referensi Indikator" icon="plus-circle" wire:click="openModal" />
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Referensi Indikator' : 'Tambah Referensi Indikator Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui informasi referensi indikator' : 'Isi form untuk menambahkan referensi indikator' }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="padding: 32px; background: #f8f9fa; max-height: 70vh; overflow-y: auto;">
                    <form wire:submit="save">
                        ...
                        <x-form.textarea
                            ...
                            icon="alert-circle"
                            model="kualifikasi_deskripsi.0.deskripsi"
                            rows="4"
                            placeholder="Masukkan uraian kualifikasi kurang"
                            :required="true"
                        />

                        <x-form.textarea
                            label="Kualifikasi (Cukup)"
                            icon="check-circle"
                            model="kualifikasi_deskripsi.1.deskripsi"
                            rows="4"
                            placeholder="Masukkan uraian kualifikasi cukup"
                            :required="true"
                        />

                        <x-form.textarea
                            label="Kualifikasi (Baik)"
                            icon="star"
                            model="kualifikasi_deskripsi.2.deskripsi"
                            rows="4"
                            placeholder="Masukkan uraian kualifikasi baik"
                            :required="true"
                        />
                    </form>
                </div>
