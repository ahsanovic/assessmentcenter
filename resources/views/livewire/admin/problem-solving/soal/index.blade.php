<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <x-modal.btn-add text="Tambah Soal" icon="plus-circle" wire:click="openModal" />
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Soal Problem Solving' : 'Tambah Soal Problem Solving Baru' }}
                            </h5>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select wire:model="form.aspek_id" class="form-select @error('form.aspek_id') is-invalid @enderror">
                                        <option value="">Pilih jenis aspek</option>
                                        @foreach ($aspek_option as $key => $item)
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select wire:model="form.indikator_nomor" class="form-select @error('form.indikator_nomor') is-invalid @enderror">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <x-form.textarea
                                    ...
                                    model="form.opsi_e"
                                    rows="3"
                                    placeholder="Masukkan pilihan jawaban E"
                                    :required="true"
                                />
                            </div>
                            <div class="col-md-4">
