<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => route('admin.soal-problem-solving'), 'title' => 'Problem Solving'],
        ['url' => null, 'title' => 'Soal']
    ]" />
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form wire:submit="save">
                        ...
                        <a href="{{ route('admin.soal-problem-solving') }}" wire:navigate class="btn btn-sm btn-inverse-danger me-2">Batal</a>
                        <button
                            type="submit"
