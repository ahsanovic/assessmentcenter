<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => null, 'title' => 'Pelanggaran Tes Potensi']
    ]" />
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <x-monitoring.page-header
                        icon="alert-triangle"
                        color="warning"
                        title="Pelanggaran Tes Potensi"
                        description="Rekap log pelanggaran ujian potensi per event."
                    />
                                    ...
                                    <tr class="@if($loop->iteration % 2 == 1) bg-body @endif border-bottom">
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-outline-warning rounded-pill px-3 py-1" wire:navigate
                                                href="{{ route('admin.pelanggaran-tes.show', ['idEvent' => $item->id ]) }}">
                                                    Lihat Detail
                                            </a>
                                        </td>
                                    </tr>
