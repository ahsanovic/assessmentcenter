<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => null, 'title' => 'Pelanggaran Tes PSPK']
    ]" />
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <x-monitoring.page-header
                        icon="alert-triangle"
                        color="warning"
                        title="Pelanggaran Tes PSPK"
                        description="Rekap log pelanggaran ujian PSPK per event."
                    />
                                    ...
                                    <tr class="@if($loop->iteration % 2 == 1) bg-body @endif border-bottom">
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-outline-warning rounded-pill px-3 py-1" wire:navigate
                                                href="{{ route('admin.pelanggaran-tes-pspk.show', ['idEvent' => $item->id ]) }}">
                                                    Lihat Detail
                                            </a>
                                        </td>
                                    </tr>
