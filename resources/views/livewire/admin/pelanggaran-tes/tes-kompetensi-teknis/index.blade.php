<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => null, 'title' => 'Pelanggaran Tes Kompetensi Teknis']
    ]" />
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <x-monitoring.page-header
                        icon="alert-triangle"
                        color="warning"
                        title="Pelanggaran Tes Kompetensi Teknis"
                        description="Rekap log pelanggaran ujian kompetensi teknis per event."
                    />
                            ...
                            <tbody>
                                @foreach ($data as $index => $item)
                                    <tr class="@if($loop->iteration % 2 == 1) bg-body @endif border-bottom">
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-outline-warning rounded-pill px-3 py-1" wire:navigate
                                                href="{{ route('admin.pelanggaran-tes-kompetensi-teknis.show', ['idEvent' => $item->id ]) }}">
                                                    Lihat Detail
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                @if($data->count() === 0)
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-5 ac-empty-state">
                                            ...
                                            <div class="mt-2 fw-semibold">Tidak ada data pelanggaran...</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
