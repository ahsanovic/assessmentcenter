        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Soal Sub Tes 2" icon="plus-circle" />
                                ...
                                @if($data->count() === 0)
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-4">
                                            ...
                                            <div class="mt-2 fw-semibold">Tidak ada data soal sub tes 2...</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Soal Sub Tes 2' : 'Tambah Soal Sub Tes 2 Baru' }}
                            </h5>
