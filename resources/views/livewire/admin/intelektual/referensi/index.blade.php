                ...
                <div class="modal-body" style="padding: 32px; background: #f8f9fa; max-height: 70vh; overflow-y: auto;">
                    <form wire:submit="save">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <x-form.textarea
                                    label="Uraian Potensi (Kurang)"
                                    icon="minus"
                                    model="kualifikasi.3.uraian_potensi"
                                    placeholder="Masukkan uraian potensi untuk kategori Kurang"
                                    :required="true"
                                    :rows="4"
                                />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <x-form.textarea
                                    label="Uraian Potensi (Sangat Kurang)"
                                    icon="thumbs-down"
                                    model="kualifikasi.4.uraian_potensi"
                                    placeholder="Masukkan uraian potensi untuk kategori Sangat Kurang"
                                    :required="true"
                                    :rows="4"
                                />
                            </div>
