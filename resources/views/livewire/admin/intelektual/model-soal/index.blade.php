        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Model Soal" icon="plus-circle" />
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Model Soal' : 'Tambah Model Soal Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui informasi model soal' : 'Isi form untuk menambahkan model soal' }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="padding: 32px; background: #f8f9fa;">
                    <form wire:submit="save">
                        <x-form.input
                            ...
                            icon="package"
                            model="form.jenis"
                            placeholder="Masukkan nama model soal"
                            :required="true"
                        />
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">
                                <i class="link-icon me-2" data-feather="toggle-right"></i>
                                Status
                            </label>
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" wire:model="form.is_active" id="radioAktif" value="true">
                                    <label class="form-check-label" for="radioAktif">
                                        Aktif
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" wire:model="form.is_active" id="radioNonAktif" value="false">
