            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form wire:submit="save">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    >{{ $kualifikasi[0]['uraian_potensi'] ?? '' }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    >{{ $kualifikasi[1]['uraian_potensi'] ?? '' }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    >{{ $kualifikasi[2]['uraian_potensi'] ?? '' }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    >{{ $kualifikasi[3]['uraian_potensi'] ?? '' }}</textarea>
                        ...
                        <div class="mt-3">
                            <a href="{{ route('admin.ref-kecerdasan-emosi') }}" wire:navigate class="btn btn-sm btn-inverse-danger me-2">Batal</a>
                            <button
                                type="submit"
