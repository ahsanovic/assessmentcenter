                                ...
                                @if($data->count() === 0)
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-4">
                                            ...
                                            <div class="mt-2 fw-semibold">Tidak ada data pertanyaan penilaian...</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Pertanyaan Penilaian' : 'Tambah Pertanyaan Penilaian Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui pertanyaan penilaian pribadi' : 'Isi form untuk menambahkan pertanyaan' }}
                            </p>
                        </div>
                    </div>
