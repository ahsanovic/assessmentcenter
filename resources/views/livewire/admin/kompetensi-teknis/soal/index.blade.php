        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-modal.btn-add text="Tambah Soal Kompetensi Teknis" icon="plus-circle" />
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit Soal Kompetensi Teknis' : 'Tambah Soal Kompetensi Teknis Baru' }}
                            </h5>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select wire:model="form.jenis_jabatan" class="form-select @error('form.jenis_jabatan') is-invalid @enderror">
                                        <option value="">Pilih jenis jabatan</option>
                                        @foreach ($jenis_jabatan_options as $key => $item)
                                            <option value="{{ $key }}">{{ $item }}</option>
                                        @endforeach
