                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="modal-title text-white fw-bold mb-0" style="font-size: 1.5rem;">
                                {{ $isUpdate ? 'Edit TTD Laporan' : 'Tambah TTD Laporan Baru' }}
                            </h5>
                            <p class="text-white-50 mb-0 mt-1" style="font-size: 0.875rem;">
                                {{ $isUpdate ? 'Perbarui data TTD laporan' : 'Isi form untuk menambahkan TTD laporan' }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="padding: 32px; background: #f8f9fa;">
                    <form wire:submit="save">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold mb-2" style="color: #344054; font-size: 0.875rem; letter-spacing: 0.01em;">
                                <span class="d-flex align-items-center gap-2">
                                    <i class="link-icon" data-feather="image" style="width: 16px; height: 16px;"></i>
                                    TTE (maksimal 200 KB)
                            ...
                            @if ($ttd_url)
                                <div class="mb-3">
                                    <img src="{{ $ttd_url }}" class="img-fluid rounded border" style="max-width: 200px;">
                                </div>
                            @endif
                            <input 
                                ...
                                type="file" 
                                accept="image/*"
                                style="padding: 12px 16px; border-radius: 10px; border: 2px solid #e0e0e0;"
                            >
                            <div wire:loading wire:target="ttd" class="mt-2">
                                <span class="text-primary"><i class="link-icon" data-feather="upload-cloud"></i> Uploading...</span>
                            </div>
                            @error('ttd')
                        ...
                        <x-form.radio-group
                            label="Status"
                            icon="power"
                            model="modal_is_active"
                        >
                            <div class="form-check">
                                <input 
                                    type="radio" 
                                    class="form-check-input" 
                                    wire:model="modal_is_active"
                                    id="aktifTtd" 
                                    value="t"
                                    style="cursor: pointer;"
                                >
                                <label class="form-check-label" for="aktifTtd" style="cursor: pointer;">
                                    <span class="badge bg-success">Aktif</span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input 
                                    ...
                                    style="cursor: pointer;"
                                >
                                <label class="form-check-label" for="nonAktifTtd" style="cursor: pointer;">
                                    <span class="badge bg-danger">Non Aktif</span>
                                </label>
                            </div>
                        </x-form.radio-group>
