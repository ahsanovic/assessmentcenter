<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => null, 'title' => 'Monitoring Tes Potensi']
    ]" />
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <x-monitoring.page-header
                        icon="activity"
                        color="primary"
                        title="Monitoring Tes Potensi"
                        description="Pantau progres ujian potensi setiap peserta per sub-tes. Klik jumlah peserta pada kolom sub-tes untuk melihat detail."
                    />
                                ...
                                @if ($data->count() === 0)
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-5 ac-empty-state">
                                            ...
                                            <div class="mt-2 fw-semibold">Tidak ada data ujian potensi berlangsung...</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
