<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => route('admin.tes-selesai.intelektual'), 'title' => 'Hasil Tes Intelektual Sub Tes 2'],
                                    ...
                                    <tr class="@if($loop->iteration % 2 == 1) bg-body @endif border-bottom">
                                        ...
                                        <td>
                                            <button
                                                ...
                                                wire:click="setUjianKeBelumSelesaiConfirmation('{{ $item->ujian_intelektual_subtes_2_id }}')"
