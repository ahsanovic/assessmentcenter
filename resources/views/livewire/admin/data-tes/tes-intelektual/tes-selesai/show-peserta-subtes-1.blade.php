<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => route('admin.tes-selesai.intelektual'), 'title' => 'Tes Intelektual Sub Tes 1 Selesai'],
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->is_finished == 'true')
                                                <button wire:click="deleteConfirmation('{{ $item->hasil_intelektual_id }}')" tabindex="0" class="btn btn-xs btn-outline-danger">
                                                    Hapus
                                                </button>
                                            @endif
                                        </td>
