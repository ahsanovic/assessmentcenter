<div wire:poll.visible.30s>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => route('admin.tes-berlangsung.intelektual'), 'title' => 'Monitoring Tes Intelektual Sub Tes 3'],
                                    ...
                                    <tr class="@if($loop->iteration % 2 == 1) bg-body @endif border-bottom">
                                        ...
                                        <td>
                                            ...
                                            <button
                                                ...
                                                wire:click="openModal('{{ $item->ujian_intelektual_subtes_3_id }}')"
                                            ...
                                            <x-table.btn-delete :id="$item->ujian_intelektual_subtes_3_id" />
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
