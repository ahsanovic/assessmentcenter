<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => null, 'title' => 'Monitoring Tes Intelektual']
    ]" />
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <x-monitoring.page-header
                        icon="activity"
                        color="primary"
                        title="Monitoring Tes Intelektual"
                        description="Pantau progres ujian intelektual setiap peserta per sub-tes."
                    />
                                ...
                                @if ($data->count() === 0)
                                    <tr>
                                        <td colspan="9" class="text-center text-muted py-5 ac-empty-state">
                                            ...
                                            <div class="mt-2 fw-semibold">Tidak ada data ujian intelektual berlangsung...</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
