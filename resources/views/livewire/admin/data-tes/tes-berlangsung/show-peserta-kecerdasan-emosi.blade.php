<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Peserta Tes Kecerdasan Emosi - {{ $event->nama_event }}</h6>
                            ...
                            <tbody>
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->is_finished == 'false')
                                                <button wire:click="deleteConfirmation('{{ $item->ujian_kecerdasan_emosi_id }}')" tabindex="0" class="btn btn-xs btn-outline-danger">
                                                    Hapus
                                                </button>
                                            @endif
                                        </td>
