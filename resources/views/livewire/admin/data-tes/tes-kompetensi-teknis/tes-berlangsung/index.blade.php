<div>
    <x-breadcrumb :breadcrumbs="[
        ...
        ['url' => null, 'title' => 'Monitoring Tes Kompetensi Teknis']
    ]" />
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <x-monitoring.page-header
                        icon="activity"
                        color="primary"
                        title="Monitoring Tes Kompetensi Teknis"
                        description="Pantau progres ujian kompetensi teknis setiap peserta secara langsung."
                    />
                            ...
                            <tbody>
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-warning {{ $item->ujian_kompetensi_teknis_count == 0 ? 'disabled' : '' }}" wire:navigate
                                                href="{{ route('admin.tes-berlangsung.kompetensi-teknis.show-peserta', ['idEvent' => $item->id]) }}">
                                                    {{ $item->ujian_kompetensi_teknis_count }} orang
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
