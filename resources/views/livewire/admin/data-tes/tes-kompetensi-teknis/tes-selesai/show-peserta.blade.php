<div>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Hasil Tes Kompetensi Teknis - {{ $event->nama_event }}</h6>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-sm-4 mb-3 d-flex justify-content-end">
                            <div class="me-2">
                                <a href="{{ route('admin.tes-selesai.kompetensi-teknis.download-rekap', $event->id) }}?tanggalTes={{ $tanggal_tes ? \Carbon\Carbon::parse($tanggal_tes)->format('Y-m-d') : '' }}"
